<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddJaDiferenca.aspx.cs" Inherits="GUIA.usu.AddJaDiferenca" %>
...
<body>
    ...
    <form id="form1" runat="server">
           <asp:Button runat="server" class="btn btn-danger" Text="Apagar Todas as diferenças" OnClick="Unnamed1_Click"/>
