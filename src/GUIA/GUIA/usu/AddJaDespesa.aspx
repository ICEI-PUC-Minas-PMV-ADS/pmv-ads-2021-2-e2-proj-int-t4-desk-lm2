<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddJaDespesa.aspx.cs" Inherits="GUIA.usu.AddJaDespesa" %>
...
<body>
    ...
    <div class="w3-bar w3-green w3-center">
      ...
      <br>
            <form runat="server">
                <asp:Button runat="server" class="btn btn-danger" Text="Apagar Todas as despesas" OnClick="Unnamed1_Click" />
