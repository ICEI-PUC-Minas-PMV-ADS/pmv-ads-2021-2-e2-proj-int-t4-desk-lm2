<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControleDespesas.aspx.cs" Inherits="GUIA.admin.ControleDespesas" %>
    ...
    <a href="../index.html" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Sair</a>
      ...
      <h2>Listagem de Despesas</h2>
        ...
        <form id="form1" runat="server">
              <div>
            <asp:GridView ID="GridViewDespesas" runat="server"  BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnRowCancelingEdit="GridViewDespesas_RowCancelingEdit" OnRowDeleting="GridViewDespesas_RowDeleting" OnRowEditing="GridViewDespesas_RowEditing" OnRowUpdating="GridViewDespesas_RowUpdating">
                <Columns>
