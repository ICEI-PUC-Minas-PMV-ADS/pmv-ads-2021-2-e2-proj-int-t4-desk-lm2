<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GerenciaUser.aspx.cs" Inherits="GUIA.admin.GerenciaUser" %>
...
<body>
  ...
  <div class="w3-bar w3-green">
    ...
    <a href="../index.html" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Sair</a>
      ...
      <h2>Realizar Cadastro de Usuarios</h2>
      <br>
    ...
    <form id="form1" runat="server">
      <div class="form-group">
            ...
            <br>
            <asp:Button ID="BtnCadastrar" class="btn btn-warning" runat="server" Text="Cadastrar" OnClick="BtnCadastrar_Click" />
    </form>
         </div>
</body>
</html>
