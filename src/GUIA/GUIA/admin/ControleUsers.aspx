<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControleUsers.aspx.cs" Inherits="GUIA.admin.ControleUsers" %>
...
<body>
  ...
  <div class="w3-bar w3-green">
    ...
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridViewUsuarios" runat="server" OnRowDeleting="GridView1_RowDeleting" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnRowCancelingEdit="GridViewUsuarios_RowCancelingEdit" OnRowEditing="GridViewUsuarios_RowEditing" OnRowUpdating="GridViewUsuarios_RowUpdating">
                <Columns>
