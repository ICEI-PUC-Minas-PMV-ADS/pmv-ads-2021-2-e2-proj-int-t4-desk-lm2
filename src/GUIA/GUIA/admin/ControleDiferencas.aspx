<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControleDiferencas.aspx.cs" Inherits="GUIA.admin.ControleDiferencas" %>
...
<body>
  ...
  <div class="w3-bar w3-green">
    ...
    <div  id="cadastro" class="container" style="max-width:2000px;margin-top:70px">
      <h2>Listagem de Diferenças</h2>
          <br>
    <form id="form1" runat="server">
        <div>
             <asp:GridView ID="GridViewDiferencas" runat="server"  BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnRowCancelingEdit="GridViewDiferencas_RowCancelingEdit" OnRowDeleting="GridViewDiferencas_RowDeleting" OnRowEditing="GridViewDiferencas_RowEditing" OnRowUpdating="GridViewDiferencas_RowUpdating">
                <Columns>
